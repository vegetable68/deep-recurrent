...
class RNN {
	...
	private:
		...
		MatrixXd Wo, Wfo, Wbo, WWfo[layers - 1], WWbo[layers - 1],
				 WWfoy, WWboy;
		VectorXd bo;
		...
		MatrixXd gWo, gWfo, gWbo, gWWfo[layers - 1], gWWbo[layers - 1],
				 gWWfoy, gWWboy;
		VectorXd gbo;
		...
		MatrixXd vWo, vWfo, vWbo, vWWfo[layers - 1], vWWbo[layers - 1],
				 vWWfoy, vWWboy;
		VectorXd vbo;
...
int main(int argc, char **argv) {
	...
	readSentences(X, T, "agent.txt"); // dse.txt or ese.txt
